...
class Box2(WorldObj):
    def __init__(self, color='purple', contains=None):
        super(Box2, self).__init__('box2', color)
...
class Box(WorldObj):
    def __init__(self, color='green', contains=None):
...
class Grid:
    ...
    def slice(self, topX, topY, botX, botY):
        """
    ...
    def render_tile(
        ...
        key = obj.encode_o() + key if obj else key
...
class MiniGridEnv(gym.Env):
    ...
    def get_obs_render(self, obs, tile_size=TILE_PIXELS//2):
        ...
        img = grid.render(
            tile_size,
            agent_pos=(self.agent_view_size // 2-1, self.agent_view_size - 3),
            agent_dir=3,
