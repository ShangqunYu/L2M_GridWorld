...
def experiment(variant):
    ...
    dyna = BNNdynamics(obs_dim, action_dim, device = ptu.device,weight_out=0.1)
    qf1_set = []
    qf2_set = []
    vf_set = []
    policy_set = []
    ...
    for i in range(len(env)):
        ...
        forward_dyna = BNNdynamics(obs_dim, action_dim, device=ptu.device,learning_rate=0.001,deterministic=False,weight_out=0.1)
