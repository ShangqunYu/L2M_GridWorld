...
default_config = dict(
    ...
    algo_params=dict(
        ...
        max_path_length=100, # max path length for this environment
        ...
        vf_lr=3E-4,
        context_lr=3e-4,
        reward_scale=2., # scale rewards before constructing Bellman update, effectively controls weight on the entropy of the policy
