...
class MetaRLAlgorithm(metaclass=abc.ABCMeta):
    def __init__(
            ...
            num_exp_traj_eval=1,
            update_post_train=1,
            num_updates_global=1500,  #need to change to back to 1500 first
            num_updates_task=1000,  #need to change to back to 1000 first
            global_update_interval=300,
            before_train=5000,   #need to change back to 5000
            max_traj=10,
